...
namespace entropy {
    ...
    class NoiseGen {
      ...
      private:
        ...
        void SingleDomainWarpBasicGrid(int seed, float warpAmp, float frequency, float x, float y, float z, float &xr,
        ...
        void SingleDomainWarpOpenSimplex2Gradient(int seed, float warpAmp, float frequency, float x, float y, float z,
                                                  float &xr, float &yr, float &zr, bool outGradOnly) const;
